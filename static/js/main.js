$(document).ready(function(){
    ...
    // Pass molfile data from sketcher to the textfield

    // $('#get_mol').on('click', function(){
    // 	var mol = sketcher.getMolecule();
    // 	var molfile = ChemDoodle.writeMOL(mol);
    // 	$("txt_area").val(molfile);
    // });
    ...
    // Convert smiles or mol to chemfig 
